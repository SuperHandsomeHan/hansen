 ...
 */
@ComponentScan(basePackages = "edu.nf.hansen",  excludeFilters = {@ComponentScan.Filter(type = FilterType.ANNOTATION, classes = {Controller.class, RestController.class, EnableWebMvc.class})})
/**
